...
public class FtpUtils {
     ...
     * @param                上传到服务器的文件名
     * @param               FTP目录如:/path1/pathb2/,如果目录不存在会自动创建目录
     * @return
     */
    ...
    public static void main(String[] args) {
        FtpUtils f = new FtpUtils("129.226.137.36", 21, "user", "`123456poilkj");
        try {
            if (f.open()) {
                //上传
                f.upload("C:\\001.jpg");
                ...
                //下载
                boolean b = f.get("/imgextra/002.png", "D:/金/个人站/003.png");
                System.out.println(b);

                //删除
                String ftpDirAndFileName = "/imgextra/002.png";
