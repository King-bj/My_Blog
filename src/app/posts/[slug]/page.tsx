...
export default function PostPage() {
  ...
  // useParams() in client components returns URL-encoded path segments — for
  // non-ASCII slugs (e.g. Chinese) we must decode before passing to the API
  // helper, which encodes again. Without this, double-encoding makes the
  // server look up a file with literal "%E5..." characters and 404s.
