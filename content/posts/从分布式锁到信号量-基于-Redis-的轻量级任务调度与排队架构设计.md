---
title: 从分布式锁到信号量：基于 Redis 的轻量级任务调度与排队架构
date: "2025-06-25"
tags: [架构设计, DevOps]
description: "运维平台并发任务调度演进：从 Redis 分布式锁到可过期信号量，实现公平排队、Runner 隔离与任务超时保护，含完整架构图与核心代码。"
published: true
---

# 从分布式锁到信号量：基于 Redis 的轻量级任务调度与排队架构

## 背景

在自动化运维平台中，大量脚本需要分发到不同主机执行，且需要保证任务公平性和执行隔离。
